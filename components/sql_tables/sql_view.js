...
/**
* Class to handle browsing views
*/
var Views = (function() {
  ...
  var showView = function(viewName) {
    currentManager = new TableManager(viewName, "view");
    currentManager.showGrid = showGrid;
    currentManager.onDataLoad = function() { };
    currentManager.baseSql = "select * from " + escapeSql(viewName);

    currentManager.load({
      action: "exec",
      sql: currentManager.baseSql
    });
  }
